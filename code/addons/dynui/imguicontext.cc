...
ImguiContext::Create()
{
    ...
    colors[ImGuiCol_Header] = ImVec4(1.00f, 0.55f, 0.10f, 0.40f);
    colors[ImGuiCol_HeaderHovered] = ImVec4(0.74f, 0.37f, 0.00f, 0.20f);
    colors[ImGuiCol_HeaderActive] = ImVec4(0.74f, 0.37f, 0.00f, 0.30f);
